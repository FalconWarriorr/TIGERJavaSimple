...
public class Constants {
	...
	public final static int BL_DRIVE_TALON = 3;		//These IDs may not be correct for your robot			 //
													//To find the correct ID open internet explorer and go to//
	public final static int FR_DRIVE_TALON = 2;		//roboRIO-####-FRC.local where #### is your team number	 //
	public final static int BR_DRIVE_TALON = -1;	//once there you can find the IDs for all of your talons //
